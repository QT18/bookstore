...
?>
    <!---->
    <h1 class="mt-4">Danh sách Tác giả
        ...
        <table id="datatablesSimple" class="datatable-table">
            <thead>
                <tr>
                    ...
                    <th data-sortable="true" style="width: 15.35107587768969%;"><a href="#" class="datatable-sorter">Tên Tác giả</a></th>
                    <th data-sortable="true" style="width: 40.835787089467722%;"><a href="#" class="datatable-sorter">Mô tả</a></th>
                    <th data-sortable="true" style="width: 13.720271800679502%;"><a href="#" class="datatable-sorter">Chức Năng</a></th>
                </tr>
            </thead>
            <tbody>
                <?php $stt =1; foreach ($tacgia as $item): ?>
                    <tr>
                        <td><?php echo $stt ?></td>
